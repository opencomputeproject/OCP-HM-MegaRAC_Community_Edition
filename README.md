...
What is the reason:
- Megarac Community edition has all lot of repos, not possible to keep all the repos in one self contained repo.
- Very difficult to sync with AMI OneTree (openbmc based AMI next generation BMC stack) when repo structures are different, not scalable.

Where is the OCP community edition:
