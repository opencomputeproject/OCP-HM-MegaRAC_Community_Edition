...
BootOption::BootOption(const std::string& name, const std::string& bootoptionreference , const std::string& uefidevpath ,const std::string& displayname , bool bootoptionenabled,
	...
	objServer(objectServer) ,name(name)
{
	...
	bootoptionInterface->register_property("BootOptionReference",bootoptionreference);
