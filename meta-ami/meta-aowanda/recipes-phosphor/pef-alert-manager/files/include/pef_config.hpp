...
static constexpr const char *pefPostponeTmrIntf = "xyz.openbmc_project.pef.PEFPostponeTimer";
...
static constexpr const char* pefConfFilePath = "/usr/share/pef-alert-manager/pef-alert-manager.json";
...
/**
 *parsePefConfToDbus - Parse all configuration data from json and create dbus property for json entries.
 **/
