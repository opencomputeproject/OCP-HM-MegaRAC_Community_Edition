...
extern int lattice_get_id_pub(unsigned int *id);
extern int cpldcm();

/*************************************************************************************/
/* LC LC4064V-XXT4 */
extern int lc4064v_xxt4_cpld_erase(void);
extern int lc4064v_xxt4_cpld_program(FILE *jed_fd);
extern int lc4064v_xxt4_cpld_verify(FILE *jed_fd);

/*************************************************************************************/
/* LC LCMXO2280C */
extern int lcmxo2280c_cpld_erase(void);
extern int lcmxo2280c_cpld_program(FILE *jed_fd);
extern int lcmxo2280c_cpld_verify(FILE *jed_fd);

extern int lcmxo2_70000he_cpld_erase(void);
extern int lcmxo2_70000he_cpld_program(FILE *jed_fd);
extern int lcmxo2_70000he_cpld_verify(FILE *jed_fd);
...
static struct cpld_dev_info lattice_device_list[] = {
	...
	[2] = {
		.name = "LC LCMXO2-7000HE",
		.dev_id = 0x012B5043,
		.dr_bits = 128,
		.row_num = 9212,
		.cpld_erase = lcmxo2_70000he_cpld_erase,
		.cpld_program = lcmxo2_70000he_cpld_program,
		.cpld_verify = lcmxo2_70000he_cpld_verify,
	}
};
