...
#include "xyz/openbmc_project/Cpld/Version/server.hpp"
...
using VersionInherit = sdbusplus::server::object::object<
    sdbusplus::xyz::openbmc_project::Cpld::server::Version,
...
/** @class Version
 *  @brief OpenBMC version cpld management implementation.
 *  @details A concrete implementation for xyz.openbmc_project.Cpld.Version
 *  D-Bus API.
 */
class Version : public VersionInherit
{
  public:
    /** @brief Constructs Version Cpld Manager
     *
     * @param[in] bus            - The D-Bus bus object
    ...
    std::string cpldverify(); // To verify the CPLD Device and Image 
    std::string cplderase(); // To erase the CPLD Device
    std::string cpldprogram();// To Program the CPLD Device
    std::string cpldstatus(); // TO Get CPLD Device Status
    std::string erasestatus(); // To Get CPLD erase status 
    std::string programstatus(); // To Get CPLD program Status 
    ...
    //void lattice_get_id_pub(unsigned int *id);
    /**
